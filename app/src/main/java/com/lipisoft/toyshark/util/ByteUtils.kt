...
class ByteUtils {
    ...
    companion object {
         ...
         */
        fun getAs_uint16_NetOrder(theNumber: Int): ByteArray {
         ...
         * @return byte array
         */
        fun getAs_uint32_NetOrder(theNumber: Int): ByteArray {
         ...
         */
        fun getByteNetOrderTo_uint8(theBytes: ByteArray, idx: Int): Int {
         ...
         */
        fun getByteNetOrderTo_unit16(theBytes: ByteArray, idx: Int): Int {
            var sum = 0
            for (i in 0..1) {
         ...
         * @return the num (0-65535)
         */
        fun getByteLittleEndian_unit16(theBytes: ByteArray, idx: Int): Int {
            var sum = 0
            for (i in 0..1) {
                sum = (sum shl 8) + (0xff and theBytes[i + idx].toInt())
            }
         ...
         * @return the num
         */
        fun getByteNetOrderTo_unit32(theBytes: ByteArray, idx: Int): Long {
            var sum: Long = 0
            for (i in 0..3) {
