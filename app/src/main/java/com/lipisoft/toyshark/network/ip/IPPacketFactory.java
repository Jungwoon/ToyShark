...
public class IPPacketFactory {
    ...
    public static IPv4Header copyIPv4Header(@NonNull IPv4Header iPv4Header) {
        return new IPv4Header(
                iPv4Header.getIpVersion(),
                iPv4Header.getHeaderLength(),
                iPv4Header.getDscp(),
                iPv4Header.getEcn(),
    ...
    public static byte[] createIPv4HeaderData(@NonNull IPv4Header header) {
        ...
        buffer[0] = (byte) ((header.getHeaderLength() & 0xF) | 0x40);
        buffer[1] = (byte) ((header.getDscp() << 2) & (header.getEcn() & 0xFF));
    ...
    public static IPv4Header createIPv4Header(@NonNull ByteBuffer stream) throws PacketHeaderException {
        ...
        final byte typeOfService = stream.get();
        final byte dscp = (byte) (typeOfService >> 2);
        final byte ecn = (byte) (typeOfService & 0x03);
