...
/**
 * Publish packet packetQueue to subscriber who implements interface IReceivePacket
 *
 * @author Borey Sao
 * Date: June 15, 2014
 */
class SocketDataPublisher : Runnable {
    ...
    /**
     * register a subscriber who wants to receive packet packetQueue
     *
     * @param subscriber a subscriber who wants to receive packet packetQueue
     */
